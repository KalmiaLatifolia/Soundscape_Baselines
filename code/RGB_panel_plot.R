...
ENT_SierraLeone_avgDay$Country <- "Sierra Leone"
ENT_Brunei_avgDay$Country <- "Brunei"
ENT_Singapore_avgDay$Country <- "Singapore"

# add realm column -------------------------------------------------------------
ACI_USA_avgDay$Realm <- "Holarctic"
...
ENT_SierraLeone_avgDay$Realm <- "Afrotropic"
ENT_Brunei_avgDay$Realm <- "Indomalayan"
ENT_Singapore_avgDay$Realm <- "Indomalayan"


# merge avgDay -----------------------------------------------------------------
ACI_avgDay <- rbind(ACI_USA_avgDay, ACI_Germany_avgDay, ACI_Ecuador_avgDay, ACI_Peru_avgDay, ACI_Gabon_avgDay, ACI_SierraLeone_avgDay, ACI_Brunei_avgDay, ACI_Singapore_avgDay)
EVN_avgDay <- rbind(EVN_USA_avgDay, EVN_Germany_avgDay, EVN_Ecuador_avgDay, EVN_Peru_avgDay, EVN_Gabon_avgDay, EVN_SierraLeone_avgDay, EVN_Brunei_avgDay, EVN_Singapore_avgDay)
ENT_avgDay <- rbind(ENT_USA_avgDay, ENT_Germany_avgDay, ENT_Ecuador_avgDay, ENT_Peru_avgDay, ENT_Gabon_avgDay, ENT_SierraLeone_avgDay, ENT_Brunei_avgDay, ENT_Singapore_avgDay)
